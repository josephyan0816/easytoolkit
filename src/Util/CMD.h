...
#ifndef EASYTOOLKIT_CMD_H
#define EASYTOOLKIT_CMD_H
...
namespace toolkit {
    ...
    public:
        ...
        std::vector<variant> splitVal(const char *key, const char *delim = ":") {

//
// Created by Joseph Yan on 2023/1/22.
//

#ifndef EASYTOOLKIT_SOCKUTIL_H
#define EASYTOOLKIT_SOCKUTIL_H
...
//套接字工具类，封装了socket,网络的一些基本操作
    ...
    public:
         ...
         * @return -1代表失败，其他为socket fd号
         */
        static int bindUdpSock(const uint16_t port, const char *local_ip = "::", bool enable_resue = true);

        /**
         * @brief 解除与sock 相关的绑定关系
         * @param sock,sock fd 号
         * @return 0 成功，-1失败
         */
